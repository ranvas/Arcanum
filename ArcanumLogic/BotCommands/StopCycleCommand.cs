...
public class StopCycleCommand : RootSendCommand
{
    public override string Command { get; set; } = $"/{DispatcherCommandsEnum.stop_cycle}";
    ...
    {
        var result = await dispatcher.DispatchSimple<string>(DispatcherCommandsEnum.stop_cycle.ToString());
