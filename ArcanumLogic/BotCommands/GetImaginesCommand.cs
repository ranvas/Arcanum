...
{
    public class GetImaginesCommand : VipCommand
    {
        public override string Command { get => $"/{DispatcherCommandsEnum.imagines}"; set => base.Command = value; }
        ...
        {
            var result = await dispatcher.DispatchSimple<string>(DispatcherCommandsEnum.imagines.ToString());
